import 'package:consumindo_api/src/models/coin_model.dart';
import 'package:consumindo_api/src/repositories/coin_repository.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  test('Converter um xml em uma lista de CoinModel', () {
    final repository = CoinRepository();
    final coins = repository.parseCoins(xml);
    print(coins);
  });

  test('Pegar apenas a cotação', () {
    final repository = CoinRepository();
    final quotation = repository.parseQuotation(json, 'USDBRL');

    expect(quotation, 4.862);
  });
}
